...
{
    self.lbl_ListLine.hidden=FALSE;
    self.lbl_MapLine.hidden=TRUE;
    
    self.tbl_Pharmacies.hidden=FALSE;
    self.mapView.hidden=TRUE;
}
-(IBAction)MapClicked
{
    self.lbl_ListLine.hidden=TRUE;
    self.lbl_MapLine.hidden=FALSE;
    
    self.tbl_Pharmacies.hidden=TRUE;
