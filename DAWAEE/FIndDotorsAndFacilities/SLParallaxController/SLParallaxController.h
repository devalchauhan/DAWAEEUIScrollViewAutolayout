...
@property (nonatomic, strong) NSString *str_FlagFOrD;
@property (nonatomic, strong) UITextField *txt_SearchFilter;
@property (nonatomic, strong) UIView *view_Filter;
@property (nonatomic, strong) UIButton      *btn_Back,*btn_Filter;
