//
//  MyMedicationProfileViewController.h
//  DAWAEE
//
...
@interface MyMedicationProfileViewController : UIViewController


@property (nonatomic,weak) IBOutlet UITableView *tbl_Profiles;
// For menu
