//
//  MyMedicationProfileViewController.m
//  DAWAEE
//
...
@interface MyMedicationProfileViewController ()

@end

@implementation MyMedicationProfileViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([tableView isEqual:self.tbl_Profiles]) {
        if(!cell){
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
     ...
     if ([tableView isEqual:self.tbl_Profiles]) {
         ProfileMedicineViewController *obj_ProfileMedicineViewController = [[ProfileMedicineViewController alloc] initWithNibName:@"ProfileMedicineViewController" bundle:nil];
         [self.navigationController pushViewController:obj_ProfileMedicineViewController animated:YES];
     }
     else {
    self.view_Menu.hidden=TRUE;
    self.view_Gradient.hidden=TRUE;
