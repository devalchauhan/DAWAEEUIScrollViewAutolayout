...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([tableView isEqual:self.tbl_Profiles]) {
        ProfileDetailViewController *obj_ProfileDetailViewController = [[ProfileDetailViewController alloc] initWithNibName:@"ProfileDetailViewController" bundle:nil];
        [self.navigationController pushViewController:obj_ProfileDetailViewController animated:YES];
    }
    else {
    self.view_Menu.hidden=TRUE;
    self.view_Gradient.hidden=TRUE;
